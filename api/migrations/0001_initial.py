# Generated by Django 2.2.5 on 2019-12-30 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_entity_template', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='relation_annotation', to='api.Relation_entity_template')),
        ...
        migrations.AddField(
            model_name='entity_annotation',
            name='event_group_annotation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entity_annotation', to='api.Event_group_annotation'),
        ),
        migrations.AddField(
            model_name='entity_annotation',
            name='role',
        ...
        migrations.AddField(
            model_name='doc',
            name='epoch',
            field=models.ManyToManyField(related_name='doc', to='api.Epoch'),
        ),
        migrations.AddField(
            model_name='doc',
            name='project',
